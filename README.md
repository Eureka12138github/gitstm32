...
| [2-1 STM32 工程模版](00-Common/2-1%20STM32 工程模版/ "2-1 Project Template") | Keil MDK base project template |
...
| Name | Function |
| --- | --- |
| [3-1 LED 闪烁](01-Basic/3-1%20LED 闪烁/ "3-1 LED Blink") | GPIO output |
| [3-2 LED 流水灯](01-Basic/3-2%20LED 流水灯/ "3-2 LED Chaser") | Sequential GPIO control |
| [3-3 蜂鸣器](01-Basic/3-3%20蜂鸣器/ "3-3 Buzzer") | Buzzer control |
| [3-4 按键控制 LED](01-Basic/3-4%20按键控制 LED/ "3-4 Button Control") | GPIO input detection |
| [3-5 红外线控制蜂鸣器](01-Basic/3-5%20红外线控制蜂鸣器/ "3-5 IR Sensor") | IR sensor + buzzer |
| [4-1 OLED 显示屏](01-Basic/4-1%20OLED 显示屏/ "4-1 OLED Display") | SSD1306 display driver |
| [4-2 OLED 显示屏 - 中文显示](01-Basic/4-2%20OLED 显示屏%20-%20中文显示/ "4-2 OLED Chinese") | Chinese character display |
| [4-3 轻量型 OLED UI（待优化）](01-Basic/4-3%20轻量型 OLED UI（待优化）/ "4-3 OLED UI") | Lightweight UI framework |
...
| [9-3 串口收发 Hex 数据包](02-Communication/9-3%20串口收发 Hex 数据包/ "9-3 UART Hex") | UART Binary Protocol | - |
| [9-4 串口收发文本数据包](02-Communication/9-4%20串口收发文本数据包/ "9-4 UART Text") | UART Text Protocol | - |
| [10-1 软件 I2C 读写 MPU6050](02-Communication/10-1%20软件 I2C 读写 MPU6050/ "10-1 SW I2C") | I2C (Software) | MPU6050 |
| [10-2 硬件 I2C 读写 MPU6050](02-Communication/10-2%20硬件 I2C 读写 MPU6050/ "10-2 HW I2C") | I2C (Hardware) | MPU6050 |
| [11-1 软件 SPI 读写 W25Q64](02-Communication/11-1%20软件 SPI 读写 W25Q64/ "11-1 SW SPI") | SPI (Software) | W25Q64 |
| [11-2 硬件 SPI 读写 W25Q64](02-Communication/11-2%20硬件 SPI 读写 W25Q64/ "11-2 HW SPI") | SPI (Hardware) | W25Q64 |
...
| [6-3 PWM 驱动 LED 灯](03-Timer/6-3%20PWM 驱动 LED 灯/ "6-3 PWM LED") | PWM dimming |
| [6-4 PWM 驱动舵机](03-Timer/6-4%20PWM 驱动舵机/ "6-4 Servo") | Servo control |
| [6-5 PWM 驱动直流电机](03-Timer/6-5%20PWM 驱动直流电机/ "6-5 DC Motor") | Motor speed control |
| [6-6 输入捕获模式测频率](03-Timer/6-6%20输入捕获模式测频率/ "6-6 Input Capture") | Frequency measurement |
| [6-7 PWMI 测频率占空比](03-Timer/6-7%20PWMI 测频率占空比/ "6-7 PWMI") | PWM analysis |
...
| Name | Function |
| --- | --- |
| [7-1 AD 单通道](04-ADC-DMA/7-1%20AD 单通道/ "7-1 Single ADC") | Single-channel ADC |
| [7-2 AD 多通道](04-ADC-DMA/7-2%20AD 多通道/ "7-2 Multi ADC") | Multi-channel scanning |
| [8-1 DMA 数据转运](04-ADC-DMA/8-1%20DMA 数据转运/ "8-1 DMA Transfer") | DMA transfer |
| [8-2 DMA+AD 多通道](04-ADC-DMA/8-2%20DMA+AD 多通道/ "8-2 DMA+ADC") | ADC + DMA combined |
...
| [13-2 睡眠模式 + 串口发送 + 接收](05-Advanced/13-2%20睡眠模式 + 串口发送 + 接收/ "13-2 Sleep Mode") | Sleep low-power mode |
| [13-3 停止模式 + 对射式红外传感器计次](05-Advanced/13-3%20停止模式 + 对射式红外传感器计次/ "13-3 Stop Mode") | Stop low-power mode |
| [13-4 待机模式 + 实时时钟](05-Advanced/13-4%20待机模式 + 实时时钟/ "13-4 Standby Mode") | Standby low-power mode |
...
| [15-1 读取内部 FLASH](05-Advanced/15-1%20读取内部 FLASH/ "15-1 Internal FLASH") | Internal FLASH programming |
| [15-2 读取芯片 ID](05-Advanced/15-2%20读取芯片 ID/ "15-2 Chip ID") | Unique device ID |
...
| Name | Purpose |
| --- | --- |
| [9-6 FlyMcu 串口下载&Stlink Utility](99-Tools/9-6%20FlyMcu 串口下载&Stlink%20Utility/ "9-6 Download Tools") | Program download tools |
| [STM32 疑难杂症](99-Tools/STM32 疑难杂症/ "Troubleshooting") | Troubleshooting guides |
| [VOFA 测试](99-Tools/VOFA 测试/ "VOFA+ Debug") | VOFA+ serial debugger |
| [X-1 51 程序移植（DS18B20 温度读取）](99-Tools/X-1%2051 程序移植（DS18B20 温度读取）/ "51 Migration") | 8051 to STM32 migration |
...
---
*Happy Coding & Learning!*
>>>>>>> d4311191129e4dfcd50ecbe343e0906c0c520fe7
