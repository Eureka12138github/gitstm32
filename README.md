...
| [3-4 按键控制 LED](01-Basic/3-4%20按键控制 LED/) | GPIO input detection |
| [3-5 红外线控制蜂鸣器](01-Basic/3-5%20红外线控制蜂鸣器/) | IR sensor + buzzer |
| [4-1 OLED 显示屏](01-Basic/4-1%20OLED 显示屏/) | SSD1306 display driver |
| [4-2 OLED 显示屏 - 中文显示](01-Basic/4-2%20OLED 显示屏%20-%20中文显示/) | Chinese character display |
| [4-3 轻量型 OLED UI（待优化）](01-Basic/4-3%20轻量型 OLED UI（待优化）/) | Lightweight UI framework |
| [5-1 对射式红外传感器计次](01-Basic/5-1%20对射式红外传感器计次/) | Object counting application |
...
| [9-4 串口收发文本数据包](02-Communication/9-4%20串口收发文本数据包/) | UART Text Protocol | - |
| [10-1 软件 I2C 读写 MPU6050](02-Communication/10-1%20软件 I2C 读写 MPU6050/) | I2C (Software) | MPU6050 |
| [10-2 硬件 I2C 读写 MPU6050](02-Communication/10-2%20硬件 I2C 读写 MPU6050/) | I2C (Hardware) | MPU6050 |
| [11-1 软件 SPI 读写 W25Q64](02-Communication/11-1%20软件 SPI 读写 W25Q64/) | SPI (Software) | W25Q64 |
| [11-2 硬件 SPI 读写 W25Q64](02-Communication/11-2%20硬件 SPI 读写 W25Q64/) | SPI (Hardware) | W25Q64 |
...
| [6-3 PWM 驱动 LED 灯](03-Timer/6-3%20PWM 驱动 LED 灯/) | PWM dimming |
| [6-4 PWM 驱动舵机](03-Timer/6-4%20PWM 驱动舵机/) | Servo control |
| [6-5 PWM 驱动直流电机](03-Timer/6-5%20PWM 驱动直流电机/) | Motor speed control |
| [6-6 输入捕获模式测频率](03-Timer/6-6%20输入捕获模式测频率/) | Frequency measurement |
| [6-7 PWMI 测频率占空比](03-Timer/6-7%20PWMI 测频率占空比/) | PWM analysis |
| [6-8 编码器接口测速](03-Timer/6-8%20编码器接口测速/) | Quadrature decoder |
| [6-9 定时器测量函数执行时间](03-Timer/6-9%20定时器测量函数执行时间/) | Performance profiling |
| [5-2 旋转编码器计次](03-Timer/5-2%20旋转编码器计次/) | Encoder counting |
...
| [8-2 DMA+AD 多通道](04-ADC-DMA/8-2%20DMA+AD 多通道/) | ADC + DMA combined |
...
| [13-2 睡眠模式 + 串口发送 + 接收](05-Advanced/13-2%20睡眠模式 + 串口发送 + 接收/) | Sleep low-power mode |
| [13-3 停止模式 + 对射式红外传感器计次](05-Advanced/13-3%20停止模式 + 对射式红外传感器计次/) | Stop low-power mode |
| [13-4 待机模式 + 实时时钟](05-Advanced/13-4%20待机模式 + 实时时钟/) | Standby low-power mode |
| [14-1 独立看门狗](05-Advanced/14-1%20独立看门狗/) | Independent watchdog (IWDG) |
| [14-2 窗口看门狗](05-Advanced/14-2%20窗口看门狗/) | Window watchdog (WWDG) |
| [15-1 读取内部 FLASH](05-Advanced/15-1%20读取内部 FLASH/) | Internal FLASH programming |
| [15-2 读取芯片 ID](05-Advanced/15-2%20读取芯片 ID/) | Unique device ID |
...
| [X-1 51 程序移植（DS18B20 温度读取）](99-Tools/X-1%2051 程序移植（DS18B20 温度读取）/) | 8051 to STM32 migration |
| [模块学习](99-Tools/模块学习/) | Module tutorials (DHT11, stepper motor) |
| [练习](99-Tools/练习/) | Practice projects (stopwatch, digital clock) |
...
Intermediate → 02-Communication (UART/I2C/SPI) 
             ↓
Advanced → 03-Timer (PWM/Input Capture) 
         ↓
Expert → 04-ADC-DMA + 05-Advanced
```
